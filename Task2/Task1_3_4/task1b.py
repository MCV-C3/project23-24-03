...
test_neurons = [[4096, 4096, 4096, 4096, 4096],
                [4096, 4096, 2048, 1024, 256],
                [4096, 2048, 2048, 1024, 256],
                [4096, 2048, 1024, 1024, 256],
                [4096, 2048, 1024, 256, 256],
                [4096, 2048, 256, 256, 256],
                [4096, 1024, 1024, 256, 256],
                [4096, 1024, 256, 256, 256],
]

for neurons in test_neurons:
    model = build_model(IMG_SIZE, 5, neurons, None, None, 'sgd', 0.01)
