...
try:
    optuna.delete_study(storage='sqlite:///optuna.db', study_name='s2_2b')
except:
    pass
study = optuna.create_study(storage='sqlite:///optuna.db', study_name= "s2_2b", direction='maximize')
study.optimize(lambda trial: objective(trial, (train_images, train_labels), (test_images, test_labels), NUMBER_OF_EPOCHS, (IMG_HEIGHT, IMG_WIDTH, 3), 100), n_trials=100, n_jobs=1)
