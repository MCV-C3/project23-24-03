...
def optuna_model_s2_1(trial, input_shape, classes, activation, regularizer, initializer):
    ...
    n_blocks = trial.suggest_int(f'n_blocks', 5, 8)
    ...
    for i in range(n_blocks):
        ...
        filters = trial.suggest_categorical(f'block_{i}_filters', [16, 32, 64, 96, 128, 256])
...
try:
    optuna.delete_study(storage='sqlite:///optuna.db', study_name='s2_1b')
except:
    pass
study = optuna.create_study(storage='sqlite:///optuna.db', study_name= "s2_1b", direction='maximize')
